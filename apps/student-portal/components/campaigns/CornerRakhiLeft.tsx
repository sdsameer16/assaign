...
export const CornerRakhiLeft: React.FC = () => {
  return (
    <div className="absolute top-[64px] sm:top-[68px] md:top-[72px] left-1 sm:left-3 md:left-5 pointer-events-none z-35 overflow-visible">
      <svg
      ...
      >
        <defs>
          <radialGradient id="img2LeftJewel" cx="45%" cy="45%" r="55%">
            <stop offset="0%" stopColor="#FF80AB" />
            <stop offset="35%" stopColor="#F50057" />
            <stop offset="75%" stopColor="#C51162" />
            <stop offset="100%" stopColor="#880E4F" />
          </radialGradient>
          <radialGradient id="img2GoldBead" cx="35%" cy="35%" r="65%">
            <stop offset="0%" stopColor="#FFF9C4" />
            <stop offset="40%" stopColor="#FFD54F" />
            <stop offset="85%" stopColor="#FF8F00" />
            <stop offset="100%" stopColor="#E65100" />
          </radialGradient>
          <radialGradient id="img2PearlBead" cx="35%" cy="35%" r="65%">
            <stop offset="0%" stopColor="#FFFFFF" />
            <stop offset="50%" stopColor="#FFF9C4" />
            <stop offset="85%" stopColor="#F5F5F5" />
            <stop offset="100%" stopColor="#E0E0E0" />
          </radialGradient>
          <linearGradient id="img2LeftMangoLeaf" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#66BB6A" />
            <stop offset="60%" stopColor="#2E7D32" />
            <stop offset="100%" stopColor="#1B5E20" />
          </linearGradient>
          <linearGradient id="img2RedThread" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#FFD700" />
            <stop offset="50%" stopColor="#D32F2F" />
            <stop offset="100%" stopColor="#B71C1C" />
          </linearGradient>
          <linearGradient id="img2OrangeThread" x1="0%" y1="0%" x2="0%" y2="100%">
            <stop offset="0%" stopColor="#FFD700" />
            <stop offset="50%" stopColor="#FF9800" />
            <stop offset="100%" stopColor="#E65100" />
          </linearGradient>
          <filter id="img2LeftGlow" x="-20%" y="-20%" width="140%" height="140%">
        ...
        <g transform="translate(70, 70)">
          <path d="M 0,0 C -25,-20 -40,-10 -55,0 C -35,15 -15,10 0,0 Z" fill="url(#img2LeftMangoLeaf)" />
          <path d="M 0,0 C -35,15 -45,35 -40,55 C -20,40 -10,20 0,0 Z" fill="url(#img2LeftMangoLeaf)" />
          <path d="M 0,0 C 15,35 35,45 55,40 C 40,20 20,10 0,0 Z" fill="url(#img2LeftMangoLeaf)" />
        </g>

        {/* 2. ORNATE RAKHI DISC (EXACT DESIGN FROM IMAGE 2) */}
        <g transform="translate(70, 70)" filter="url(#img2LeftGlow)">
          ...
          {[0, 30, 60, 90, 120, 150, 180, 210, 240, 270, 300, 330].map((deg) => (
            <g key={deg} transform={`rotate(${deg})`}>
              <path d="M 0,-34 C -5,-41 0,-45 0,-45 C 0,-45 5,-41 0,-34 Z" fill="url(#img2GoldBead)" />
              <circle cx="0" cy="-30" r="2.5" fill="url(#img2PearlBead)" />
            </g>
          ))}
          ...
          <circle cx="0" cy="0" r="14" fill="url(#img2LeftJewel)" className="rakhi-jewel-pulse" />
        ...
        {/* Left String: Red Tassel */}
        <g transform="translate(45, 118)" className="rakhi-tassel-sway">
          <line x1="0" y1="0" x2="0" y2="140" stroke="url(#img2RedThread)" strokeWidth="2" strokeDasharray="4 2" />
          <circle cx="0" cy="20" r="3.5" fill="url(#img2GoldBead)" />
          <circle cx="0" cy="40" r="4" fill="url(#img2PearlBead)" />
          <circle cx="0" cy="65" r="4.5" fill="#D32F2F" />
          <circle cx="0" cy="90" r="3.5" fill="url(#img2GoldBead)" />
          <circle cx="0" cy="115" r="4" fill="url(#img2PearlBead)" />
        ...
        {/* Right String: Orange Tassel */}
        <g transform="translate(95, 118)" className="rakhi-tassel-sway" style={{ animationDelay: "0.6s" }}>
          <line x1="0" y1="0" x2="0" y2="160" stroke="url(#img2OrangeThread)" strokeWidth="2" strokeDasharray="4 2" />
          <circle cx="0" cy="25" r="3.5" fill="url(#img2PearlBead)" />
          <circle cx="0" cy="50" r="4.5" fill="url(#img2GoldBead)" />
          <circle cx="0" cy="78" r="4" fill="#E65100" />
          <circle cx="0" cy="105" r="3.5" fill="url(#img2PearlBead)" />
          <circle cx="0" cy="132" r="4.5" fill="url(#img2GoldBead)" />
