...
export default function StudentPortal() {
  ...
  return (
    <div className={`min-h-screen font-sans pb-24 transition-colors duration-300 ${theme === "dark" ? "bg-slate-950 text-slate-100" : "bg-slate-50 text-slate-900"}`}>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <button
                  onClick={() => {
                    setShowAccountDrawer(false);
                    setShowWhatsappCommunity(true);
                  }}
                  className={`w-full border p-3 rounded-2xl text-xs font-bold flex items-center justify-between transition mt-2 ${
                    theme === "dark"
                ...
                >
                  <div className="flex items-center space-x-2.5">
                    ...
                    <span>WhatsApp Community & Offers</span>
                  </div>
                  <ChevronRight className={`w-4 h-4 ${theme === "dark" ? "text-emerald-500" : "text-emerald-400"}`} />
                </button>
      ...
      {/* Support & WhatsApp FABs */}
      <div className={`fixed bottom-6 z-50 flex flex-col space-y-3 transition-all duration-300 ${isCartOpen ? "left-6 items-start" : "right-6 items-end"}`}>
        <AnimatePresence>
          {showWhatsappCommunity && (
            <motion.div
              ...
              className={`rounded-3xl p-5 shadow-2xl border w-80 origin-bottom-right transition-colors ${
                theme === "dark" ? "bg-slate-900 border-slate-800 text-slate-100" : "bg-white border-slate-100 text-slate-900"
              }`}
            >
              <div className={`flex items-center justify-between mb-4 border-b pb-4 ${theme === "dark" ? "border-slate-800" : "border-slate-100"}`}>
                <div className="flex items-center space-x-3">
                  <div className="w-10 h-10 rounded-full bg-[#25D366] flex items-center justify-center shrink-0 shadow-md shadow-[#25D366]/30">
                    <WhatsappIcon className="w-5 h-5 text-white" />
                  </div>
                  <div>
                    <h3 className="font-bold text-base leading-tight">WhatsApp Community</h3>
                    <p className={`text-[10px] font-bold uppercase tracking-wider ${theme === "dark" ? "text-emerald-400" : "text-emerald-600"}`}>
                      Official Channel
                    </p>
                  </div>
                </div>
                <button
                  ...
                  className={`p-1.5 rounded-full transition ${theme === "dark" ? "hover:bg-slate-800 text-slate-400" : "hover:bg-slate-100 text-slate-500"}`}
                >
                  <X className="w-4 h-4" />
                </button>
              </div>
              ...
              <div className="space-y-4">
                <div className={`p-3.5 rounded-2xl border ${theme === "dark" ? "bg-emerald-950/30 border-emerald-900/40 text-emerald-200" : "bg-emerald-50 border-emerald-100 text-emerald-900"}`}>
                  <p className="text-xs leading-relaxed font-semibold">
                    Join our community for existing announcements, and offers!
                  </p>
                </div>
                ...
                <div className="space-y-1.5">
                  ...
                  <a
                    ...
                    className={`block p-3 rounded-2xl border text-xs font-mono break-all transition font-semibold ${
                      theme === "dark"
                        ? "bg-slate-950 border-slate-800 text-emerald-400 hover:border-emerald-500/50 hover:bg-emerald-950/20"
                        : "bg-slate-50 border-slate-200 text-emerald-600 hover:border-emerald-300 hover:bg-emerald-50/50"
                    }`}
                  >
                    https://whatsapp.com/channel/0029VbD7NoSEVccDCgghMI3K
                  </a>
                </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-full bg-[#25D366] hover:bg-[#20ba5a] text-white font-bold py-3 px-4 rounded-2xl flex items-center justify-center space-x-2 shadow-lg shadow-[#25D366]/30 transition transform hover:scale-[1.02] active:scale-[0.98]"
                >
                  <WhatsappIcon className="w-5 h-5 text-white" />
        ...
        {/* WhatsApp Logo Button (Above Customer Care Headphones Icon) */}
        <button
          onClick={() => {
            setShowWhatsappCommunity(!showWhatsappCommunity);
            if (!showWhatsappCommunity) setShowSupport(false);
          }}
          title="Join WhatsApp Community"
          className="w-14 h-14 bg-[#25D366] hover:bg-[#20ba5a] rounded-full shadow-lg shadow-[#25D366]/40 flex items-center justify-center transition-transform hover:scale-105 active:scale-95 relative group"
        >
          {showWhatsappCommunity ? (
        ...
        {/* Headphones / Customer Care Button */}
        <button
          onClick={() => {
            setShowSupport(!showSupport);
            if (!showSupport) setShowWhatsappCommunity(false);
          }}
          title="CampusBites Customer Care"
